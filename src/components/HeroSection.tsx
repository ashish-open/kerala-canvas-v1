  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      >
        ...
        >
          <source src="https://qfvz8goiejzixlan.public.blob.vercel-storage.com/4k-aerial-top-down-drone-shot-of-a-25-year-old-ind-2025-12-17-20-40-47-utc.mp4" type="video/mp4" />
        </video>
